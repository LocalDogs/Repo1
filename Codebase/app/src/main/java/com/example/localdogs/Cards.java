...
public class Cards {
    ...
    public void defaultDogs2(){
        spots.add(new Spot(new Dog("amelia@stinkywinky.com","Monster", new ArrayList<String>(Arrays.asList("Golden Retriever")), new dob(8,15,2010), 62, 7, "https://s3localdogsimages234609-dev.s3.us-east-2.amazonaws.com/public/hurrdurr%40tankycommie.com/Charlie.png")));
        spots.add(new Spot(new Dog("jane@winkystinky.com","Max", new ArrayList<String>(Arrays.asList("Pitbull", "Staffie")), new dob(12,31,2008), 50, 2, "https://i.imgur.com/E0MbHhU.jpg")));
    }
